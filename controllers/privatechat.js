    ...
    getChatPage: function (req, res) {
      async.parallel(
        [
          ...
          //agregarea pentru returnarea mesajelor private in chatul privat
          function (callback) {
          ...
          //cautarea mesajelor dintre cei doi utilizatori din chatul privat
          function (callback) {
        ...
        (err, results) => {
          ...
          const nameParams = params[0].replace(/-/g, " ");

          res.render('private/privatechat', {
            title: 'Cigames Chat - Private Chat',
            user: req.user,
            data: result1,
            chat: result2,
            chats: result3,
